...
class BertEmbeddings(nn.Module):
    ...
    def __init__(self, config):
        ...
        # hard code here
#         self.x_position_embeddings = nn.Embedding(1024, config.hidden_size)
#         self.y_position_embeddings = nn.Embedding(1024, config.hidden_size)
#         self.h_position_embeddings = nn.Embedding(1024, config.hidden_size)
#         self.w_position_embeddings = nn.Embedding(1024, config.hidden_size)
    ...
    # hard code: bbox
    def forward(
        self, input_ids=None, bbox = None, token_type_ids=None, position_ids=None, inputs_embeds=None, past_key_values_length=0
    ):
...
#         print('attention_probs_dropped, ', attention_probs_dropped.shape)
#         print('value_layer, ', value_layer.shape)
#         print('context_layer is ', context_layer.shape)
        context_layer = context_layer.permute(0, 2, 1, 3).contiguous()
        new_context_layer_shape = context_layer.size()[:-2] + (self.all_head_size,)
        context_layer = context_layer.view(*new_context_layer_shape)
#         print('new_context_layer_shape is ', context_layer.shape)
...
#         print('self_outputs is ', self_outputs[0].shape)
